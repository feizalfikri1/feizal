...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('assets/backend/apple-icon.png')}}">
    <link rel="shortcut icon" href="favicon.ico">

    <link rel="stylesheet" href="{{asset('assets/backend/vendors/bootstrap/dist/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/backend/vendors/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/backend/vendors/themify-icons/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{asset('assets/backend/vendors/flag-icon-css/css/flag-icon.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/backend/vendors/selectFX/css/cs-skin-elastic.css')}}">
    <link rel="stylesheet" href="{{asset('assets/backend/vendors/jqvmap/dist/jqvmap.min.css')}}">
...
<body>
    ...
    <script src="{{asset('assets/backend/vendors/popper.js/dist/umd/popper.min.js')}}"></script>
    ...
    <script src="{{asset('assets/backend/vendors/chart.js/dist/Chart.bundle.min.js')}}"></script>
    <script src="{{asset('assets/backend/assets/js/dashboard.js')}}"></script>
    <script src="{{asset('assets/backend/assets/js/widgets.js')}}"></script>
    <script src="{{asset('assets/backend/vendors/jqvmap/dist/jquery.vmap.min.js')}}"></script>
