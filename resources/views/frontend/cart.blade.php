        ...
        <div class="container">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td class="image-prod">
                                        <div class="img" style="background-image:url(assets/frontend/images/product-3.jpg);">
                                        </div>
                                    </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="image-prod">
                                        <div class="img" style="background-image:url(assets/frontend/images/product-4.jpg);">
                                        </div>
                                    </td>
            ...
            <div class="row justify-content-end">
                <div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
                    ...
                    <p class="text-center"><a href="/cekout" class="btn btn-primary py-3 px-4">Proceed to Checkout</a>
                    </p>
                </div>
            </div>
        </div>
